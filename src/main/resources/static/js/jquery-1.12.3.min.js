...
!function (a, b) {
    ...
    function ea(a, b) {
        ...
        if (!f) for (f = [
        ], c = a.childNodes || a; null != (d = c[e]); e++) !b || n.nodeName(d, b) ? f.push(d)  : n.merge(f, ea(d, b));
    ...
    n.each({
        ...
        n.fn[a] = function (a) {
            for (var c, d = 0, e = [
            ], f = n(a), h = f.length - 1; h >= d; d++) c = d === h ? this : this.clone(!0),
            n(f[d]) [b](c),
            g.apply(e, c.get());
    ...
    !function () {
        ...
        if (j.style) {
            ...
            function k() {
                ...
                b = e = h = !1,
                c = g = !0,
                a.getComputedStyle && (l = a.getComputedStyle(j), b = '1%' !== (l || {
                }).top, h = '2px' === (l || {
                }).marginLeft, e = '4px' === (l || {
                    width: '4px'
    ...
    function ob(a, b, c) {
        ...
        1 === a.nodeType && ('height' in b || 'width' in b) && (c.overflow = [
            ...
            p.overflowX,
            p.overflowY
        ], j = n.css(a, 'display'), k = 'none' === j ? n._data(a, 'olddisplay') || Ma(a.nodeName)  : j, 'inline' === k && 'none' === n.css(a, 'float') && (l.inlineBlockNeedsLayout && 'inline' !== Ma(a.nodeName) ? p.zoom = 1 : p.display = 'inline-block')),
