...
(function ($) {
    ...
    function GTreeTable(element, options) {
        ...
        if (this.options.defaultActions !== null) {
        	...
        	this.actions = this.options.sn3Actions;        	
        }
    ...
    GTreeTableNode.prototype = {
        ...
        setMovePosition: function(position, pointerOffset) {
            ...
            if (position !== undefined) {
                ...
                this.$pointer.css('top', pointerOffset.top - 72 + 'px');
        ...
        isSelected: function (action) {
            if (action === undefined) {
                ...
                showCard(this.$node.attr('data-id'));
            } else {
    ...
    $.fn.gtreetable.defaults = {
        ...
        languages: {
            'en-US': {
                ...
                action: '',
                actions: {
                    createBefore: 'Añadir antes',
                    createAfter: 'Añadir después',
                    createFirstChild: 'Añadir subcategoría',
                    createLastChild: 'Añadir último hijo',
                    update: 'Actualizar nombre',
                    'delete': 'Eliminar'
                },
                messages: {
                    onDelete: 'Estás seguro?',
                    onNewRootNotAllowed: 'No está permitido añadir el nuevo nodo como root.',
