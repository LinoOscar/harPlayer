...
$.fn.bic_calendar = function(options) {
    ...
    this.each(function() {
        ...
        var textYearCurrentLayer = $('<div class="visualyear" style="font-size: 40px"></div>');
        ...
        function showCalendar() {
            ...
            daysMonthsLayer = $('<div id="monthsLayer" class="row" style="position:absolute;width:100%;z-index:-50;left:14px"></div>');

            //Date obj to calc the day
            var objFecha = new Date();
            objFecha.setMonth(0);

            var myYear = $("#bell").attr('alt');
            
            if ((myYear != null) && (myYear != "")) 
            {
            	objFecha.setYear(myYear);
            }
            ...
            var nextYearButton = $('<td><a href="#" class="button-year-next"><i class="glyphicon glyphicon-arrow-right" style="top: 14px;"></i></a></td>');
            //event
            ...
            var previousYearButton = $('<td><a href="#" class="button-year-previous"><i class="glyphicon glyphicon-arrow-left" style="top: 14px;"></i></a></td>');
            //event
         ...
         */
        function changeDate(year,direction) {

            if (direction == 'next')
            	$("#monthsLayer").css({"left":"14px"}).animate({"left":"-2000px"}, "slow");
            else
            	$("#monthsLayer").css({"left":"14px"}).animate({"left":"2000px"}, "slow");
            ...
            if (direction == 'next'){
            	$("#monthsLayer").css({"left":"2000px"}).animate({"left":"14px"}, "slow");
            }
            else { 
            	$("#monthsLayer").css({"left":"-2000px"}).animate({"left":"14px"}, "slow");
            }
            
            $('#monthsLayer td').on('click', function() {    	    	
            	onDayClick($(this));
            });	 
            }, 800);
        }
